...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  const is_not_dev =
    appIdentifier === "com.tigawanna.geonotes" ||
    appIdentifier === "com.tigawanna.geonotes.preview";
  if (is_not_dev) {
  ...
  return {
    ...
    updates: {
      url: "https://u.expo.dev/7236754d-2f0f-409d-948f-970fb269d990",
    },
    runtimeVersion: {
      policy: "appVersion",
    },

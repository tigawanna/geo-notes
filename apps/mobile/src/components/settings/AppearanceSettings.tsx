...
export function AppearanceSettings() {
  ...
  const toggleHapticsEnabled = useSettingsStore((state) => state.toggleHapticsEnabled);
  const handedness = useSettingsStore((state) => state.handedness);
  const toggleHandedness = useSettingsStore((state) => state.toggleHandedness);
    ...
    <List.Section>
      ...
      <List.Item
        ...
        left={(props) => (
          <List.Icon
            {...props}
            icon={handedness === "right" ? "hand-back-right" : "hand-back-left"}
          />
        )}
